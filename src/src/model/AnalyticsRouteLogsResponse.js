...
import AnalyticsRouteLogsData from "./AnalyticsRouteLogsData";
...
class AnalyticsRouteLogsResponse {
  ...
  static validateJSON(data) {
    ...
    for (const property of AnalyticsRouteLogsResponse.RequiredProperties) {
      if (!data[property]) {
        throw new Error(
          "The required field `" +
            property +
    ...
    if (data["data"]) {
      ...
      for (const item of data["data"]) {
        AnalyticsRouteLogsData.validateJsonObject(item);
      }
    }
...
export default AnalyticsRouteLogsResponse;
