    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bytes_rcvd')) {
                obj['bytes_rcvd'] = ApiClient.convertToType(data['bytes_rcvd'], 'Number');
            }
            ...
            if (data.hasOwnProperty('bytes_rcvd_secondary')) {
                obj['bytes_rcvd_secondary'] = ApiClient.convertToType(data['bytes_rcvd_secondary'], 'Number');
            }
            if (data.hasOwnProperty('bytes_sent_secondary')) {
                obj['bytes_sent_secondary'] = ApiClient.convertToType(data['bytes_sent_secondary'], 'Number');
            }
            if (data.hasOwnProperty('sessions_tcp')) {
                obj['sessions_tcp'] = ApiClient.convertToType(data['sessions_tcp'], 'Number');
            }
            if (data.hasOwnProperty('sessions_tls')) {
                obj['sessions_tls'] = ApiClient.convertToType(data['sessions_tls'], 'Number');
            }
            if (data.hasOwnProperty('notes_rcvd')) {
                obj['notes_rcvd'] = ApiClient.convertToType(data['notes_rcvd'], 'Number');
            }
