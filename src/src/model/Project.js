    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('administrative_contact')) {
                obj['administrative_contact'] = Contact.constructFromObject(data['administrative_contact']);
            }
            if (data.hasOwnProperty('technical_contact')) {
                obj['technical_contact'] = Contact.constructFromObject(data['technical_contact']);
            }
        } else if (data === null) {
            return null;
        }
