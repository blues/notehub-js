    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('best_location_type')) {
                obj['best_location_type'] = ApiClient.convertToType(data['best_location_type'], 'String');
            }
            if (data.hasOwnProperty('best_location_when')) {
                obj['best_location_when'] = ApiClient.convertToType(data['best_location_when'], 'Number');
            }
            ...
            if (data.hasOwnProperty('best_location')) {
                obj['best_location'] = ApiClient.convertToType(data['best_location'], 'String');
            }
            if (data.hasOwnProperty('best_country')) {
                obj['best_country'] = ApiClient.convertToType(data['best_country'], 'String');
            }
            if (data.hasOwnProperty('best_timezone')) {
                obj['best_timezone'] = ApiClient.convertToType(data['best_timezone'], 'String');
            }
            ...
            if (data.hasOwnProperty('tower_when')) {
                obj['tower_when'] = ApiClient.convertToType(data['tower_when'], 'Number');
            }
            ...
            if (data.hasOwnProperty('tower_country')) {
                obj['tower_country'] = ApiClient.convertToType(data['tower_country'], 'String');
            }
            if (data.hasOwnProperty('tower_location')) {
                obj['tower_location'] = ApiClient.convertToType(data['tower_location'], 'String');
            }
            if (data.hasOwnProperty('tower_timezone')) {
                obj['tower_timezone'] = ApiClient.convertToType(data['tower_timezone'], 'String');
            }
            ...
            if (data.hasOwnProperty('tri_location')) {
                obj['tri_location'] = ApiClient.convertToType(data['tri_location'], 'String');
            }
            if (data.hasOwnProperty('tri_country')) {
                obj['tri_country'] = ApiClient.convertToType(data['tri_country'], 'String');
            }
            if (data.hasOwnProperty('tri_timezone')) {
                obj['tri_timezone'] = ApiClient.convertToType(data['tri_timezone'], 'String');
            }
            if (data.hasOwnProperty('tri_points')) {
                obj['tri_points'] = ApiClient.convertToType(data['tri_points'], 'Number');
            }
