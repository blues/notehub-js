    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('http_headers')) {
                obj['http_headers'] = ApiClient.convertToType(data['http_headers'], {'String': 'String'});
            }
            if (data.hasOwnProperty('disable_http_headers')) {
                obj['disable_http_headers'] = ApiClient.convertToType(data['disable_http_headers'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('message_group_id')) {
                obj['message_group_id'] = ApiClient.convertToType(data['message_group_id'], 'String');
            }
            if (data.hasOwnProperty('message_deduplication_id')) {
                obj['message_deduplication_id'] = ApiClient.convertToType(data['message_deduplication_id'], 'String');
            }
