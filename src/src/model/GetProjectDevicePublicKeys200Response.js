...
class GetProjectDevicePublicKeys200Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('device_public_keys')) {
                obj['device_public_keys'] = ApiClient.convertToType(data['device_public_keys'], [GetProjectDevicePublicKeys200ResponseDevicePublicKeysInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['device_public_keys']) { // data not null
            ...
            for (const item of data['device_public_keys']) {
                GetProjectDevicePublicKeys200ResponseDevicePublicKeysInner.validateJsonObject(item);
            };
        }
