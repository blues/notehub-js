...
* <pre>
* var BluesNotehubJs = require('index'); // See note below*.
* var xxxSvc = new BluesNotehubJs.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new BluesNotehubJs.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new BluesNotehubJs.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new BluesNotehubJs.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
