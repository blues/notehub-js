...
let apiInstance = new BluesNotehubJs.DeviceApi();
...
let projectUID = app:2606f411-dea6-44a0-9743-1130f57d77d8; // String | 
let deviceUID = "deviceUID_example"; // String | 
let body = new BluesNotehubJs.Body(); // Body | Body or payload of singnal to be sent to the device
