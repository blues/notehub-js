...
let apiInstance = new BluesNotehubJs.ProjectApi();
...
let apiInstance = new BluesNotehubJs.ProjectApi();
let createProjectRequest = new BluesNotehubJs.CreateProjectRequest(); // CreateProjectRequest | Project to be created
