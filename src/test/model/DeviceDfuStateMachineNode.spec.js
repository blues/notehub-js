...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.DeviceDfuStateMachineNode();
  });
  ...
  describe("DeviceDfuStateMachineNode", function () {
    it("should create an instance of DeviceDfuStateMachineNode", function () {
