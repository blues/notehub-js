...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.DeviceDfuStatus();
  });
  ...
  describe("DeviceDfuStatus", function () {
    it("should create an instance of DeviceDfuStatus", function () {
      // uncomment below and update the code to test DeviceDfuStatus
