...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.TwilioRoute();
  });
  ...
  describe("TwilioRoute", function () {
    it("should create an instance of TwilioRoute", function () {
      // uncomment below and update the code to test TwilioRoute
      //var instance = new NotehubJs.TwilioRoute();
      //expect(instance).to.be.a(NotehubJs.TwilioRoute);
    });
