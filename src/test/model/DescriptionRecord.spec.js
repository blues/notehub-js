...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.DescriptionRecord();
  });
  ...
  describe("DescriptionRecord", function () {
    it("should create an instance of DescriptionRecord", function () {
      // uncomment below and update the code to test DescriptionRecord
      //var instance = new NotehubJs.DescriptionRecord();
      //expect(instance).to.be.a(NotehubJs.DescriptionRecord);
    });
