...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.DeviceDfuStatusPage();
  });
  ...
  describe("DeviceDfuStatusPage", function () {
    it("should create an instance of DeviceDfuStatusPage", function () {
      // uncomment below and update the code to test DeviceDfuStatusPage
      //var instance = new NotehubJs.DeviceDfuStatusPage();
      //expect(instance).to.be.a(NotehubJs.DeviceDfuStatusPage);
    });
