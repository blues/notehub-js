...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BluesNotehubJs.Thingworx();
  });
  ...
  describe('Thingworx', function() {
    it('should create an instance of Thingworx', function() {
      // uncomment below and update the code to test Thingworx
      //var instance = new BluesNotehubJs.Thingworx();
      //expect(instance).to.be.a(BluesNotehubJs.Thingworx);
    });
