...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.AwsRoute();
  });
  ...
  describe("AwsRoute", function () {
    it("should create an instance of AwsRoute", function () {
      // uncomment below and update the code to test AwsRoute
      //var instance = new NotehubJs.AwsRoute();
      //expect(instance).to.be.a(NotehubJs.AwsRoute);
    });
