...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.RadRoute();
  });
  ...
  describe("RadRoute", function () {
    it("should create an instance of RadRoute", function () {
      // uncomment below and update the code to test RadRoute
      //var instance = new NotehubJs.RadRoute();
      //expect(instance).to.be.a(NotehubJs.RadRoute);
    });
