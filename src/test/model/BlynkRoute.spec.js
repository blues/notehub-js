...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.BlynkRoute();
  });
  ...
  describe("BlynkRoute", function () {
    it("should create an instance of BlynkRoute", function () {
      // uncomment below and update the code to test BlynkRoute
      //var instance = new NotehubJs.BlynkRoute();
      //expect(instance).to.be.a(NotehubJs.BlynkRoute);
    });
