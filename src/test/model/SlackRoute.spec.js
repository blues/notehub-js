...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.SlackRoute();
  });
  ...
  describe("SlackRoute", function () {
    it("should create an instance of SlackRoute", function () {
      // uncomment below and update the code to test SlackRoute
      //var instance = new NotehubJs.SlackRoute();
      //expect(instance).to.be.a(NotehubJs.SlackRoute);
    });
