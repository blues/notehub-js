...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.DatacakeRoute();
  });
  ...
  describe("DatacakeRoute", function () {
    it("should create an instance of DatacakeRoute", function () {
      // uncomment below and update the code to test DatacakeRoute
      //var instance = new NotehubJs.DatacakeRoute();
      //expect(instance).to.be.a(NotehubJs.DatacakeRoute);
    });
