...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.MqttRoute();
  });
  ...
  describe("MqttRoute", function () {
    it("should create an instance of MqttRoute", function () {
      // uncomment below and update the code to test MqttRoute
      //var instance = new NotehubJs.MqttRoute();
      //expect(instance).to.be.a(NotehubJs.MqttRoute);
    });
