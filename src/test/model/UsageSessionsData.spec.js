...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.UsageSessionsData();
  });
  ...
  describe("UsageSessionsData", function () {
    it("should create an instance of UsageSessionsData", function () {
      // uncomment below and update the code to test UsageSessionsData
      //var instance = new NotehubJs.UsageSessionsData();
      //expect(instance).to.be.a(NotehubJs.UsageSessionsData);
    });
