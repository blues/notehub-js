...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.AzureRoute();
  });
  ...
  describe("AzureRoute", function () {
    it("should create an instance of AzureRoute", function () {
      // uncomment below and update the code to test AzureRoute
      //var instance = new NotehubJs.AzureRoute();
      //expect(instance).to.be.a(NotehubJs.AzureRoute);
    });
