...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.SnowflakeRoute();
  });
  ...
  describe("SnowflakeRoute", function () {
    it("should create an instance of SnowflakeRoute", function () {
      // uncomment below and update the code to test SnowflakeRoute
      //var instance = new NotehubJs.SnowflakeRoute();
      //expect(instance).to.be.a(NotehubJs.SnowflakeRoute);
    });
