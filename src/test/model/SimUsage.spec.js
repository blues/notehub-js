...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.SimUsage();
  });
  ...
  describe("SimUsage", function () {
    it("should create an instance of SimUsage", function () {
      // uncomment below and update the code to test SimUsage
      //var instance = new NotehubJs.SimUsage();
      //expect(instance).to.be.a(NotehubJs.SimUsage);
    });
