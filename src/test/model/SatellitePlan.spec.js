...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.SatellitePlan();
  });
  ...
  describe("SatellitePlan", function () {
    it("should create an instance of SatellitePlan", function () {
      // uncomment below and update the code to test SatellitePlan
      //var instance = new NotehubJs.SatellitePlan();
      //expect(instance).to.be.a(NotehubJs.SatellitePlan);
    });
    ...
    it('should have the property ntnProvider (base name: "ntn_provider")', function () {
      // uncomment below and update the code to test the property ntnProvider
      //var instance = new NotehubJs.SatellitePlan();
      //expect(instance).to.be();
    });
