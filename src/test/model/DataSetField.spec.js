...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.DataSetField();
  });
  ...
  describe("DataSetField", function () {
    it("should create an instance of DataSetField", function () {
      // uncomment below and update the code to test DataSetField
