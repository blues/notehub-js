...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.SnowpipeStreamingRoute();
  });
  ...
  describe("SnowpipeStreamingRoute", function () {
    it("should create an instance of SnowpipeStreamingRoute", function () {
      // uncomment below and update the code to test SnowpipeStreamingRoute
      //var instance = new NotehubJs.SnowpipeStreamingRoute();
      //expect(instance).to.be.a(NotehubJs.SnowpipeStreamingRoute);
    });
    ...
    it('should have the property pipeName (base name: "pipe_name")', function () {
      // uncomment below and update the code to test the property pipeName
      //var instance = new NotehubJs.SnowpipeStreamingRoute();
      //expect(instance).to.be();
    });
