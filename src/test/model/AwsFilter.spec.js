...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new NotehubJs.AwsFilter();
  });
  ...
  describe("AwsFilter", function () {
    it("should create an instance of AwsFilter", function () {
      // uncomment below and update the code to test AwsFilter
      //var instance = new NotehubJs.AwsFilter();
      //expect(instance).to.be.a(NotehubJs.AwsFilter);
    });
