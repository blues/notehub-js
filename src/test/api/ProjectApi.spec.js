...
(function (root, factory) {
  ...
  describe("ProjectApi", function () {
    ...
    describe("getProjectOTAStatus", function () {
      it("should call getProjectOTAStatus successfully", function (done) {
        //uncomment below and update the code to test getProjectOTAStatus
        //instance.getProjectOTAStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe("updateProjectFirmware", function () {
      it("should call updateProjectFirmware successfully", function (done) {
        //uncomment below and update the code to test updateProjectFirmware
        //instance.updateProjectFirmware(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
